...
if __name__ == '__main__':
    raw_input = join(dirname(__file__), "raw_data", "anonymous", "input")
    raw_output = join(dirname(__file__), "raw_data", "anonymous", "output")
    ...
    corpus_folder = join(dirname(__file__), "corpus", "anonymous")
    try:
